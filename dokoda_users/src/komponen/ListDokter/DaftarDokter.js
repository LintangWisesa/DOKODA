...
class DaftarDokter extends Component{
    ...
    ambilAntrian = (nomor, pktp, keluhan) => {
        ...
        var url = `http://localhost:1234/pantri/${pktp}${this.state.dataDokter[nomor].dstr}`
        var namaDok = this.state.dataDokter[nomor].dnama
        var namaRS = this.state.dataDokter[nomor].rsnama
